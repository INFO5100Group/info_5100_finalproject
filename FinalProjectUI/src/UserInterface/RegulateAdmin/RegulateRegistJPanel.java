...
public class RegulateRegistJPanel extends javax.swing.JPanel {
    ...
    private Enterprise currRgeOffice;
    /**
    ...
    public RegulateRegistJPanel( Account account, EcoSystem system) {
        ...
        this.system = system;
        this.currRgeOffice = system.getEnterprises().getEnterpriseByAccout(account);
        populateTable();
        populateCombo();
        setTable();
    }
    ...
    public void populateTable(){
        ...
        model.setRowCount(0);
        for(Organization o : currRgeOffice.getDepartments()){
    ...
    public void populateCombo(){
        ...
        ComboRole.addItem("");// 0
        ComboRole.addItem("Enviromental Scientist"); // 1
        ComboRole.addItem("License Approval Officer"); // 2
    }
    ...
    private void btnRegistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistActionPerformed
        if(inputValidate()){
            ...
            if(ComboRole.getSelectedIndex() == 1){
                a.setRole(new RegulateScientistRole());
            }else if(ComboRole.getSelectedIndex() == 2){
                a.setRole(new RegulateOfficerRole());
            }
            ...
            currRgeOffice.getDepartments().get(0).getEmployee().addPerson(a.getPerson());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        currRgeOffice.getDepartments().get(0).getEmployee().removePerson(a.getPerson());
